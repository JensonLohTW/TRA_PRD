...
CREATE PROCEDURE sp_verify_financial_balance(
    ...
    OUT p_total_debit DECIMAL(14, 0),
    OUT p_total_credit DECIMAL(14, 0),
    OUT p_error_message VARCHAR(500)
)
    READS SQL DATA
    COMMENT '驗證傳票借方總額等於貸方總額'
BEGIN
...
CREATE PROCEDURE sp_reconcile_payment_batch(
    ...
    OUT p_is_consistent TINYINT
)
    MODIFIES SQL DATA
    COMMENT '產生批次、名冊和傳票對賬結果'
BEGIN
    DECLARE v_batch_total DECIMAL(14, 0);
    DECLARE v_batch_count INT;
    DECLARE v_claim_total DECIMAL(14, 0);
    DECLARE v_roster_total DECIMAL(14, 0);
    DECLARE v_voucher_total DECIMAL(14, 0);
